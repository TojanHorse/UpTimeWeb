<template>
    <div class="d-flex justify-content-center align-items-center">
        <div class="logo d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="fs-4 fw-bold">UpTimeWeb</div>
            ...
            <div class="my-3 update-link"><a href="https://github.com/TojanHorse/UpTimeWeb.git" target="_blank" rel="noopener">{{ $t("Check Update On GitHub") }}</a></div>
            ...
            <div class="mt-5">
                <p>{{ $t("Font Twemoji by Twitter licensed under") }} <a href="https://opensource.org/license/mit">Credits - Team Bytes</a></p>
            </div>
        </div>
    </div>
</template>
